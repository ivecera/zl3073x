...
static const struct nla_policy dpll_device_set_nl_policy[DPLL_A_HITLESS_SWITCHING + 1] = {
	[DPLL_A_ID] = { .type = NLA_U32, },
	[DPLL_A_MODE] = NLA_POLICY_RANGE(NLA_U32, 1, 2),
	[DPLL_A_PHASE_OFFSET_MONITOR] = NLA_POLICY_MAX(NLA_U32, 1),
	[DPLL_A_PHASE_OFFSET_AVG_FACTOR] = { .type = NLA_U32, },
	[DPLL_A_FREQUENCY_MONITOR] = NLA_POLICY_MAX(NLA_U32, 1),
	[DPLL_A_BANDWIDTH] = { .type = NLA_U32, },
	[DPLL_A_PHASE_SLOPE_LIMIT] = { .type = NLA_U32, },
	[DPLL_A_HITLESS_SWITCHING] = NLA_POLICY_MAX(NLA_U32, 1),
};
...
static const struct genl_split_ops dpll_nl_ops[] = {
	...
	},
	{
		...
		.maxattr	= DPLL_A_HITLESS_SWITCHING,
		.flags		= GENL_ADMIN_PERM | GENL_CMD_CAP_DO,
	},
	{
