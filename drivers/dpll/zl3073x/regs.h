...
#define ZL_REG_DPLL_BW_FIXED			ZL_REG(12, 0x20, 1)
#define ZL_DPLL_BW_FIXED_BW			GENMASK(2, 0)
#define ZL_DPLL_BW_FIXED_14HZ			0
#define ZL_DPLL_BW_FIXED_29HZ			1
#define ZL_DPLL_BW_FIXED_61HZ			2
#define ZL_DPLL_BW_FIXED_141HZ			3
#define ZL_DPLL_BW_FIXED_403HZ			4
#define ZL_DPLL_BW_FIXED_470HZ			5
#define ZL_DPLL_BW_FIXED_VARIABLE		7
