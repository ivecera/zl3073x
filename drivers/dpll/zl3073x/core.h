...
enum zl3073x_flags {
	...
	ZL3073X_FLAG_BW_FIXED_470HZ_BIT,
...
#define ZL3073X_FLAG_BW_FIXED_470HZ	__ZL3073X_FLAG(BW_FIXED_470HZ)

#define ZL3073X_FLAGS_A_SERIES		(ZL3073X_FLAG_DIE_TEMP		| \
					 ZL3073X_FLAG_BW_FIXED_470HZ)
