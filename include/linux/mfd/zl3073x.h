 ...
 * @index: synth index
 *
 * Return: true if synth is enabled, false if output is disabled
 */
static inline
bool zl3073x_synth_is_enabled(struct zl3073x_dev *zldev, u8 index)
{
 ...
 */
static inline
bool zl3073x_output_is_enabled(struct zl3073x_dev *zldev, u8 index)
{
	/* Output is enabled only if associated synth is enabled */
	if (zl3073x_synth_is_enabled(zldev, zldev->output[index].synth))
 ...
 */
static inline
u8 zl3073x_synth_dpll_get(struct zl3073x_dev *zldev, u8 index)
{
 ...
 */
static inline
u32 zl3073x_synth_freq_get(struct zl3073x_dev *zldev, u8 index)
{
